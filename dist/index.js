...
const { getDotted } = __nccwpck_require__(472);
...
var iconvLite = __nccwpck_require__(813);
...
var Buffer = (__nccwpck_require__(118).Buffer);
...
var bomHandling = __nccwpck_require__(824),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(541); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __nccwpck_require__(868)(stream_module);
...
let convert;
try {
	convert = (__nccwpck_require__(36)/* .convert */ .O);
} catch (e) {}
...
(() => {
const core = __nccwpck_require__(186);
const { tryFetch } = __nccwpck_require__(493);
